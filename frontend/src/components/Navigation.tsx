    ...
    >
      <VStack spacing={12} w="full">
        ...
        <VStack spacing={6} align="stretch" w="full">
          <Button leftIcon={<Icon as={FaHome} fontSize="2xl" />} variant="ghost" w="full" justifyContent="flex-start"
            onClick={() => router.push('/')}
          ...
          >Home</Button>
          <Button leftIcon={<Icon as={FaPlus} fontSize="2xl" />} variant="ghost" w="full" justifyContent="flex-start"
          ...
          <Button leftIcon={<Icon as={FaList} fontSize="2xl" />} variant="ghost" w="full" justifyContent="flex-start"
            ...
            _active={{ bg: '#23262f', color: 'white' }}
          >Markets</Button>
          <Button leftIcon={<Icon as={FaNewspaper} fontSize="2xl" />} variant="ghost" w="full" justifyContent="flex-start"
