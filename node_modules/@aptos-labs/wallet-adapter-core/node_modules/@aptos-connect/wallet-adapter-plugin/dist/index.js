...
function networkToChainId(network) {
  switch (network) {
    ...
    default:
      return import_ts_sdk2.NetworkToChainId.devnet;
  }
}
...
var _AptosConnectWallet = class _AptosConnectWallet {
  constructor({
    ...
    if (!import_ts_sdk3.NetworkToNodeAPI[network]) {
    ...
    this.claimOptions = claimSecretKey ? { network, secretKey: new import_ts_sdk3.Ed25519PrivateKey(claimSecretKey) } : void 0;
  }
  ...
  async getNetwork() {
    ...
    const url = import_ts_sdk3.NetworkToNodeAPI[network];
    return {
      chainId,
      name: network,
      url
