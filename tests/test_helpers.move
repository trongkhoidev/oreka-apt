module yugo::test_helpers {
    ...
    public fun setup_complete_test_environment() acquires TestMintCap {
        ...
        // Setup MarketConfig and MarketRegistry for market_core_v2
        let yugo_account = account::create_account_for_test(@yugo);
        market_core_v2::initialize_market_registry(&yugo_account);
        market_core_v2::initialize_market_config(&yugo_account, @yugo);
        ...
        // Setup GlobalPool at @yugo (for market_core_v2_tests)
