...
module yugo::multi_outcome_market_tests {
    ...
    fun test_bid_multi_outcome_market(_admin: &signer, _user1: &signer, _user2: &signer) {
        ...
        let market_addr = binary_option_market::get_market_address(&market_info);
        ...
        // Verify bids
        let user1_position = binary_option_market::get_user_multi_outcome_position(USER1, market_addr);
        let user2_position = binary_option_market::get_user_multi_outcome_position(USER2, market_addr);
    ...
    fun test_binary_market_backward_compatibility(_admin: &signer, _user1: &signer, _user2: &signer) {
        ...
        // Verify bids
        let (user1_long, user1_short) = binary_option_market::get_user_position(USER1, market_addr);
        let (user2_long, user2_short) = binary_option_market::get_user_position(USER2, market_addr);
